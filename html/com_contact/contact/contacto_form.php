	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
				<?php if ($fieldset->name != 'contact') : ?>
					...
					<?php foreach ($fields as $field) : ?>
						<div class="control-group <?php echo strtolower($field->type); ?>">
							<?php if ($field->hidden) : ?>
								<div class="controls">
			...
			<div class="form-actions">
				<button class="btn btn-primary btn-envia-mail validate" type="submit"><i class="fa fa-paper-plane" aria-hidden="true"></i>
					<?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
